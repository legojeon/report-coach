      ...
      <footer className="mt-20 bg-white border-t border-gray-200 py-8">
        <div className="container mx-auto px-4">
          <div className="text-left space-y-4">
            <h3 className="font-semibold text-gray-900">(주)세종로봇코딩연구소</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
              ...
              <div className="space-y-1">
                <p>대표이사 전상현</p>
                <p>사업자등록 718-81-00599</p>
              </div>
              
              {/* 오른쪽: 이메일, 주소 */}
              <div className="space-y-1">
                <p>이메일 atto.jeon@gmail.com</p>
                <p>주소 서울시 동작구 상도로 346-2 힐스테이트상도프레스티지</p>
              </div>
            </div>
            
            <p className="text-sm text-gray-500 mt-4">© 세종로봇코딩연구소. All Rights Reserved.</p>
          </div>
        </div>
      </footer>
    </div>
